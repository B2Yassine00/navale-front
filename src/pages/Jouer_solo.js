      ...
      <main>
        <div className="container-jouer-solo">
          ...
          <div className="text-zone-jouer-solo">
            <p>
              <span className="bullet-jouer-solo"></span> Choisir la taille du
              plateau : Petit, moyen, grand.
            </p>
            <p>
              {" "}
              <span className="bullet-jouer-solo"></span> Choisir le style des
              navires.
            </p>
            <p>
              {" "}
              <span className="bullet-jouer-solo"></span> Placer les navires.
            </p>
            <Link to="/jouer/jeu">
              {" "}
              <button
                onClick={handleStartGame}
                className="start-button-jouer-solo"
              >
                Commencer la partie
              </button>
            </Link>
