...
const Accueil = () => {
  ...
  return (
    <div className="fond-accueil">
      ...
      <main>
        <div>
          <p className="title-bataille-accueil">BATAILLE</p>
        </div>
        <div>
          <p className="title-navale-accueil">Navale</p>
        </div>
        ...
        <div className="container-accueil">
          <div className="text-zone-accueil">
            ...
            <p>
              Devine où se trouvent les navires ennemis en tirant sur les cases
              de la grille adverse.
            </p>
          </div>
          <div className="star-button-accueil">
            <Link to="/jouer" className="star-text-accueil">
              JOUER
            </Link>
          </div>
          <div className="text-zone-accueil">
            ...
            <p>
              Coule tous les navires de ton adversaire avant qu'il ne coule les
              tiens.
            </p>
          </div>
        </div>
