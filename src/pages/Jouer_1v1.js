...
import "../assets/css/Jouer_1v1.css";
      ...
      <main>
        <div className="container-jouer-1v1">
          ...
          <div className="text-zone-jouer-1v1">
            <p>
              <span className="bullet-jouer-1v1"></span> Choisir la taille du
              plateau : Petit, moyen, grand.
            </p>
            <p>
              {" "}
              <span className="bullet-jouer-1v1"></span> Choisir le style des
              navires.
            </p>
            <p>
              {" "}
              <span className="bullet-jouer-1v1"></span> Placer les navires.
            </p>
            <Link to="/jouer/jeu">
              {" "}
              <button className="start-button-jouer-1v1">
                Commencer la partie
              </button>
            </Link>
          </div>
