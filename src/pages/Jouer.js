...
import solo from '../images/solo.png'; // Import de l'image pour le mode Solo
import user_co from '../images/user_co.png'; // Import de l'icône utilisateur
import './Jouer.css'; // Un fichier CSS spécifique pour cette page
      ...
      <main>
        <div className="container-jouer">
          <div className="game-mode-jouer">
            ...
            <Link to="/jouer/jouer_1v1" className="game-link-jouer">1 VS 1</Link>
          </div>

          <div className="game-mode-jouer">
            <img src={solo} alt="Solo Mode" className="game-image-jouer" />
            <Link to="/jouer/jouer_solo" className="game-link-jouer">SOLO</Link>
          </div>
        </div>
      </main>
      <footer>
